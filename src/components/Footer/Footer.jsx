			...
			<div className="container">
				...
				<div className="footer-body">
					...
					<ul className="footer-list">
						<li className="footer-list__item"></li>
						<li className="footer-list__item">
							...
							<p className="footer-list__item-text">
								<a href="tel:+79294444095">+7929 4444 095</a>
							</p>
						</li>
						...
						<li className="footer-list__item">
							<p className="footer-list__item-title">
								<IntlProvider
									...
									messages={messages[locale]}
								>
									<FormattedMessage id="loc" value={locale} />
								</IntlProvider>
							</p>
							<p className="footer-list__item-text">
								<IntlProvider
					...
					<form className="footer-form form" onSubmit={handleSubmit}>
						<img
							src={Logo}
							alt="logo"
